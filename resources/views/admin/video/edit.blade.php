	...
	<div class="tpl-content-wrapper">
				...
				<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
					<div class="widget am-cf">
						...
						<div class="widget-body am-fr">
							...
							method="post" action="/admin/video/{{ $video -> video_id }}" enctype="multipart/form-data">
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<input class="tpl-form-input" value="{{ $video -> video_name }}" id="video_name" name="video_name" placeholder="请输入视频名称"
										type="text">
										<small>
											视频名称，必须填写
										</small>
								...
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<input class="tpl-form-input" value="{{ $video -> actor }}" id="actor" name="actor" placeholder="请输入演员组合"
										type="text">
										<small>
											演员名称，必须填写;多个使用逗号分割
										</small>
								...
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<input class="tpl-form-input" value="{{ $video -> director }}" id="director" name="director" placeholder="请输入导演组合"
										type="text">
										<small>
											导演，必须填写;多个使用逗号分割
										</small>
									...
									<div class="am-u-sm-9">
										<div class="am-form-group am-form-file">
											<div class="tpl-user-panel-profile-picture">
												<img src="/{{ $video -> video_face }}" id="video_pic" alt="" />
											</div>
		...
		<i class="am-icon-cloud-upload"></i> 添加封面</button>
								...
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<textarea name="video_desc" style="width:80%;resize:none">{{ $video -> video_desc }}</textarea>
									</div>
								</div>
