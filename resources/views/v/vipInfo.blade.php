...
<html>
    ...
    <head>
        ...
        <meta name="title" content="会员成长体系" />
        <meta name="keywords" content="高清电影,热门电影,最新大片,经典大片,热播电影,综好莱坞大片,在线观看,免费观看 "
        />
        <meta name="description" content="爱奇艺（iQIYI.COM）是最具价值的网络视频播放平台；爱奇艺会员专区是针对奇艺忠实用户推出的VIP服务，为会员提供新鲜上档的国产电影和美国好莱坞大片，让爱奇艺会员享用到大片提前观看、不受广告干扰及点播电影优惠等会员专属服务；爱奇艺将一如既往丰富免费内容库，坚持友好的用户体验，视频播放清晰流畅，操作界面简单友好，真正为用户带来“悦享品质”的观映体验。"
        />
        <link rel="stylesheet" type="text/css" href="/video/css/v3-basic_high.css"
        />
        <link href="/video/css/vip-grow.css" rel="stylesheet" type="text/css"
        />
    ...
    <body class="qypage-1180">
                        ...
                        <div class="topNavLt">
                            <div class="topLogo caihong">
                                <a href="//www.iqiyi.com/" data-navpingback="logo" rseat="iQIYI_logo">
                                    <img alt="爱奇艺 iQIYI.COM" title="爱奇艺 iQIYI.COM" rseat="iQIYI_yxpz" src="/video/picture/logo108x35_black.png"
                                    />
                                </a>
                            </div>
                            <div class="topDot">
                                <a rseat="708151_channel_86" title="VIP" href="//vip.iqiyi.com/" target="_blank">
                                    <h2 class="">
                                        VIP
                                    </h2>
                                </a>
                            ...
                            <div class="clearfix">
                                ...
                                data-suggest-focusoutblacklist="iqiyi.com">
                                    <div data-widget-suggest="hotList">
                                        <a title="龙珠超" href='http://so.iqiyi.com/so/q_龙珠超' target='_blank' style="display:none;"
        ...
        <div id="block-B">
            <div class="second_newmenu second_newmenu-styleOne ">
                <div class="navboxSecond">
                    <div class="subNav">
                        <div class="navLt">
                            <a href="http://vip.iqiyi.com/" rseat="170314_VIP精选" title="VIP精选" alt="VIP精选">
                                VIP精选
                            </a>
                            |
                            <a href="http://www.iqiyi.com/dianying/vip.html?fc=a3289cd48dbb67aa" rseat="170314_电影"
                            title="电影" alt="电影">
                                电影
                            </a>
                            |
                            <a href="http://www.iqiyi.com/dianshiju/VIP.html" rseat="170314_电视剧" title="电视剧"
                            alt="电视剧">
                                电视剧
                            </a>
                            |
                            <a href="http://www.iqiyi.com/dongman/vipdongman.html" rseat="170314_动漫"
                            title="动漫" alt="动漫">
                                动漫
                            </a>
                            |
                            <a href="http://www.iqiyi.com/dianying/documentaryVIP.html" rseat="170314_纪录片"
                            title="纪录片" alt="纪录片">
                                纪录片
                            </a>
                            |
                            <a href="http://www.iqiyi.com/yinyue/VIPConcert.html" rseat="170314_演唱会"
                            title="演唱会" alt="演唱会">
                                演唱会
                            </a>
                            |
                            <a href="http://www.iqiyi.com/edu/VIPeducation.html" rseat="170314_教育"
                            title="教育" alt="教育">
                                教育
                            </a>
                            |
                            <a href="http://www.iqiyi.com/shaoer/vipkid.html" rseat="170314_儿童" title="儿童"
                            alt="儿童">
                                儿童
                            </a>
                        </div>
                        <div class="navRt">
                            <c:set var="rightNum" value="0" />
                            <a href="http://club.iqiyi.com/" rseat="170314_会员俱乐部" title="会员俱乐部" alt="会员俱乐部">
                                会员俱乐部
                            </a>
                            |
                            <a href="http://vip.iqiyi.com/upgrade.html" rseat="170314_成长体系" title="成长体系"
                            alt="成长体系" class="selected">
                                成长体系
                            </a>
                            |
                            <a href="http://account.iqiyi.com/" rseat="170314_我的账户" title="我的账户" alt="我的账户">
                                我的账户
                            </a>
                            |
                            <a href="http://help.iqiyi.com/product/1.html" rseat="170314_会员帮助中心" title="会员帮助中心"
                            alt="会员帮助中心">
                                会员帮助中心
                            </a>
                        </div>
        ...
        <!-- banner开始 -->
        <div id="block-C">
            <div class="grow_banner" style="margin-top: -44px;">
                <!-- 焦点图 开始 -->
                <div class="grow_banner-inner">
                </div>
                <!-- 焦点图 结束 -->
                <div class="grow_banner-main">
                    <!--左侧用户信息-->
                    <div class="grow_userBox">
                        <div class="grow_user-inner">
                            <div class="grow_user">
                                <div class="grow_user-pic">
                                    <a href="javascript:;">
                                        <img src="/video/picture/male-70.png" width="70" height="70" />
                                    </a>
                                </div>
                                <div class="grow_user-name">
                                    <a href="javascript:;">
                                        zhangxiaowen007
                                    </a>
                                    <!-- 有效会员 -->
                                    <i data-vipheader-elem="vipicon" class="qyv-rank qyvr-gray">
                                    </i>
                                </div>
                                <div class="grow_user-info">
                                    <!-- 下方按钮置灰加类grow_btn-gray -->
                                    <p>
                                        成长值：
                                        <em>
                                            0
                                ...
                                <div class="grow_btn">
                                    <a href="javascript:;" data-vipPay-ele="vipPayBtn" data-fcVal="83e2db9cd410928f">
                                        立即开通
                                    </a>
                                </div>
                                <div class="grow_tips1">
                                    快来开通VIP，享受丰富的等级权益吧！
                                </div>
                                <!-- 登录状态 结束 -->
                            </div>
        ...
        <div id="block-D">
            ...
            <div class="vip_grow">
                <!-- 右侧固定栏 -->
                <div class="grow-right" data-growRight-widget="rightBox">
                    <ul>
                        <li>
                            <a href="#levelSpree">
                                等级权益都有啥
                ...
                <div id="levelSpree">
                    <div class="grow_title">
                        <p class="grow_title-detail">
                            等级权益
                        </p>
                    </div>
                    <div>
                        <table class="grow_table grow-v">
                            <tbody>
                                <tr class="tr1">
                                    <th class="wd1" colspan="2">
                                        权益
                                    </th>
                                    <th class="wd2">
                                        非VIP
                                ...
                                <tr class="grow-auto">
                                    ...
                                    <td class="grow-v0-s2 grow-v">
                                        无
                                    </td>
                                    <td class="grow-v1-s2 grow-v">
                                        无
                                    </td>
                                    <td class="grow-v2-s2 grow-v">
                                        1张
                                    </td>
                                    <td class="grow-v3-s2 grow-v">
                                        2张
                                    </td>
                                    <td class="grow-v4-s2 grow-v">
                                        2张
                                    </td>
                                    <td class="grow-v5-s2 grow-v">
                                        3张
                                    </td>
                                    <td class="grow-v6-s2 grow-v">
                                        3张
                                    </td>
                                    <td class="grow-v7-s2 grow-v">
                                        4张
                                    </td>
                                </tr>
                                <tr>
                                    <td rowspan="4" class="td1 td-big">
                                        分等级专享
                                    </td>
                                    <td>
                                        生日礼包
                        ...
                        <p class="grow_notice">
                            注：升级福利每次升级仅可领取一次，重复升级不能重复领取，点播券自动发放到账户。
                        </p>
                        <p class="grow_notice notice-lt">
                            有“年”标识的福利领取周期为年，“月”标识的福利领取周期为月。
                        </p>
                        <p class="grow_notice notice-lt">
                        </p>
                    </div>
                ...
                <div id="growValue">
                    ...
                    <div class="grow_num">
                        成长值=每日成长值＋开通成长值＋任务成长值－非会员成长下降值
                        <a href="JavaScript:;" class="dn">
                            查看我的成长值账单>
                        </a>
                        <span>
                        </span>
                    ...
                    <div>
                        ...
                        <p class="grow_notice">
                            注：每次开通年卡一次性赠送500点成长值，每年最多赠送3次。
                        </p>
                        <p class="grow_notice notice-lt">
                            连续包月用户每月扣费成功一次性赠送30点成长值。
                        </p>
                        <p class="grow_notice notice-lt">
                        </p>
                    </div>
                ...
                <div id="taskGrowth">
                    <div class="grow_title">
                        <h3 class="grow_title-detail">
                            任务成长值
                        </h3>
                        <p class="grow_num-max">
                            每天最多获得30任务成长值
                        </p>
                    </div>
                    <div class="grow_task">
                        <ul>
                            <li>
                                <div class="task_bg">
                                    <div class="task_icon task_icon-qd">
                                    </div>
                                    <div class="task_txt">
                                        <h4 class="task-title">
                                            每日签到
                                ...
                                <a class="task_button" href="javascript:;" data-task-widget="signBtn"
                                data-vipType-widget="您还不是会员，无法参与任务哦，现在开通立刻做任务！">
                                    去完成
                                </a>
                                <a class="task_button task-done dn" href="javascript:;" data-task-widget="signReadyBtn">
                                    已完成
                            ...
                            <li>
                                <div class="task_bg">
                                    <div class="task_icon task_icon-phone">
                                    </div>
                                    <div class="task_txt">
                                        <h4 class="task-title">
                                            绑定手机
                                ...
                                <a class="task_button task-done" href="javascript:;">
                                    已完成
                                    <span class="task-done-icon">
                                    </span>
                                </a>
        ...
        <!-- 刚上线页面提示 -->
        <div class='dn' data-growth-ele="firstVisit">
            <div class="grow_box-tips">
                <h2 class="grow_tips-head">
                    爱奇艺VIP会员
                </h2>
                <span class="grow_tips-close" data-growth-ele="closeFloater">
                </span>
                <div class="grow_tips-main">
                    <ul>
                        <li class="tips-txt">
                            爱奇艺全新成长体系上线！
                        </li>
                        <li class="tips-txt mb30">
                            规则更简单，权益更丰富！ 还有超多任务成长值等你拿哦
                        </li>
                    </ul>
                    <div class="tips-btn">
                        <a href="javascript:;" data-growth-ele="closeFloater">
                            立即进入
                        </a>
                    </div>
                </div>
        ...
        <!-- 刚上线页面提示 end -->
        <!-- 完善生日信息弹窗 -->
        <div class="dn" data-growth-ele="birthdayBox">
            <div class="grow_box-tips">
                <h2 class="grow_tips-head">
                    爱奇艺VIP会员
                </h2>
                ...
                <div class="grow_tips-main">
                    <ul>
                        ...
                        <li class="tips-txt">
                            请于生日当月进入爱奇艺手机客户端会员俱乐部领取哦～
                        </li>
                        <li class="tips-txt-limit">
                            温馨提示：会员身份才可领取
                        </li>
                    </ul>
                    <div class="tips-btn">
        ...
        <!-- 完善生日信息弹窗 end -->
        <!--封停账号 start-->
        <div class="dn" data-growth-ele="fengtingBox">
            <div class="grow_box-tips">
                <h2 class="grow_tips-head">
                    爱奇艺VIP会员
                </h2>
                ...
                <div class="grow_tips-main">
                    ...
                    <div class="grow_tips-txtBox">
                        <p>
                            很抱歉，您的账号已经被封停，无法正常购买！
                        </p>
                        <p>
                            请
                            <a href="http://cserver.iqiyi.com/chat.html" class="green" target="_blank">
                                联系客服
                            </a>
                            解除帐号封停~
                        </p>
        ...
        <!--封停账号 end-->
        <!--非VIP-->
        <div class="dn" data-growth-ele="notVipBox">
            <!-- 成长体系非会员提示 -->
            <div class="grow_box-tips">
                <h2 class="grow_tips-head">
                    爱奇艺VIP会员
                ...
                <div class="grow_tips-main">
                    <div class="grow_tips-txtBox">
                        <p data-growth-widget="notVipBox">
                        </p>
                    </div>
                    <div class="tips-btn mt30">
                        <a href="javascript:;" data-vipPay-ele="vipPayBtn" data-fcVal="83e2db9cd410928f">
                            立即开通
                        </a>
                    </div>
        ...
        <!--非VIP end-->
        <!-- 绑定微信公众号提示 -->
        <div class="grow_box-tips dn">
            <h2 class="grow_tips-head">
                爱奇艺VIP会员
            </h2>
            <span class="grow_tips-close">
            </span>
            <div class="grow_tips-main clearfix">
                <div class="tips-lt">
                    <span class="tips-bg">
                    </span>
                    <img src="/video/picture/ewm.jpg" alt="" width="107" height="104">
                </div>
                <div class="tips-rt">
                    <ul>
                        <li class="tips-txt">
        ...
        <!--绑定微信公众号提示 end-->
        <!--绑定手机浮层-->
        <div style="position: absolute;top:50%;left:50%; margin-top: -119px; z-index: 4850; overflow: hidden; visibility:hidden; margin-left: -226px;">
            <div class="accountCenter_pop_inner accountCenter_pop_inner-small" id="widget-bindphonebox"
            style="display: block; position: static;" data-bindphonebox-title="为了方便您中奖后我们及时告知，请验证您的手机号"
            data-bindphonebox-sureText="下一步">
                ...
                <h1 class="tc">
                    ...
                    <span class="vl-inline" data-bindphonebox-elem="title">
                        为了方便您中奖后我们及时告知，请验证您的手机号
                    </span>
                </h1>
                <div class="mb5" data-bindphonebox-elem="noticeline">
                ...
                <div class="inputlist_item" data-bindphonebox-elem="mobileinputline">
                    ...
                    <input class="input-common input-common-small" type="text" placeholder="请输入您的手机号"
                ...
                <div class="inputlist_item mt20 tr">
                    <!-- <a class="fs14 mainColor mr20 vl-inline" href="#" title="取消" data-bindphonebox-elem="cancel">取消</a>-->
    ...
    <!-- Begin 艾瑞 -->
    <script>
        if (/(android)|(like mac os x)/i.test(navigator.userAgent)) { (function(d, m) {
                var i = new Image(),
            ...
            _iwt_no_flash = 1; (function(D) {
                var s = D.createElement("script"),
                h = D.getElementsByTagName("head")[0];
                s.src = "//static.iqiyi.com/js/pingback/iwt.js";
