...
$.fn.Huploadify = function(opts){
	...
	var defaults = {
		fileTypeExts:'*.wmv',//允许上传的文件类型，格式'*.jpg;*.doc'
		uploader:'',//文件提交的地址
		auto:false,//是否开启自动上传
	...
	this.each(function(){
		...
		var inputStr = '<input id="select_btn_'+instanceNumber+'" class="selectbtn" style="display:none;" type="file" name="upload_file[]"';
